...
import {
  createPointScaleErgonomicsActions,
  createBarErgonomicsActions,
  createLineErgonomicsActions,
  createFocusedLegendActions,
  createGuideRemovalActions,
  createMarkRemovalActions,
  createCartesianGuideFacadeActions,
  createErrorBarEditActions,
  createErrorBandEditActions,
  createRegressionEditActions,
  createBoxPlotEditActions
} from "./action-programs.js";
