...
export function createTemporalXPrimitives(rows) {
  const values = createTemporalBarReference(rows, {
    width: WIDTH,
    height: HEIGHT,
    margin: MARGIN
  });
  ...
  const grid = values.grid.horizontal;
  const items = values.legend.items;

  return chart()
    .createCanvas({ width: WIDTH, height: HEIGHT, margin: MARGIN, background: "white" })
    .createData({ id: "jobs", values: values.validRows })
    ...
    .editSemantic({ property: "layer[bars].encoding.color.fieldType", value: "nominal" })
    .editSemantic({ property: "layer[bars].encoding.color.scale", value: "color" })
    .editSemantic({ property: "layer[bars].encoding.color.layout", value: "group" })
    .editSemantic({ property: "layer[bars].encoding.xOffset.field", value: "sex" })
    .editSemantic({ property: "layer[bars].encoding.xOffset.fieldType", value: "nominal" })
    .editSemantic({ property: "layer[bars].encoding.xOffset.scale", value: "xOffset" })
    ...
    .createGraphics({ id: "horizontalGridLines", parent: "plot-main", type: "line", length: grid.length, before: "bars" })
    .editGraphics({ target: "horizontalGridLines", property: "x1", value: grid.map(line => line.x1) })
    .editGraphics({ target: "horizontalGridLines", property: "y1", value: grid.map(line => line.y1) })
    .editGraphics({ target: "horizontalGridLines", property: "x2", value: grid.map(line => line.x2) })
    .editGraphics({ target: "horizontalGridLines", property: "y2", value: grid.map(line => line.y2) })
    ...
    .editGraphics({ target: "horizontalGridLines", property: "strokeDash", value: grid.map(() => []) })
    ...
    .createGraphics({ id: "colorLegendSymbols", parent: "canvas", type: "rect", length: items.length })
    .editGraphics({ target: "colorLegendSymbols", property: "x", value: items.map(item => item.x) })
    .editGraphics({ target: "colorLegendSymbols", property: "y", value: items.map(item => item.y) })
    .editGraphics({ target: "colorLegendSymbols", property: "width", value: items.map(item => item.width) })
    .editGraphics({ target: "colorLegendSymbols", property: "height", value: items.map(item => item.height) })
    .editGraphics({ target: "colorLegendSymbols", property: "fill", value: items.map(item => item.color) })
    ...
    .createGraphics({ id: "colorLegendLabels", parent: "canvas", type: "text", length: items.length })
    .editGraphics({ target: "colorLegendLabels", property: "x", value: items.map(item => item.labelX) })
    .editGraphics({ target: "colorLegendLabels", property: "y", value: items.map(item => item.labelY) })
    .editGraphics({ target: "colorLegendLabels", property: "text", value: items.map(item => item.label) })
...
export function createHorizontalBarPrimitives(rows) {
  const values = createHorizontalBarReference(rows, {
    width: WIDTH,
    height: HEIGHT,
    margin: MARGIN
  });
  ...
  const xPositions = xAxis.ticks.map(tick => tick.position);
  const yPositions = yAxis.ticks.map(tick => tick.position);
  const grid = values.grid.vertical;
  const items = values.legend.items;
  ...
  return chart()
    ...
    .createBarMark({ id: "bars" })
    .editSemantic({ property: "layer[bars].coordinate", value: "main" })
    .editSemantic({ property: "layer[bars].encoding.x.field", value: "perc" })
    .editSemantic({ property: "layer[bars].encoding.x.fieldType", value: "quantitative" })
    .editSemantic({ property: "layer[bars].encoding.x.aggregate", value: "mean" })
    .editSemantic({ property: "layer[bars].encoding.x.stack", value: "zero" })
    .editSemantic({ property: "layer[bars].encoding.x.scale", value: "x" })
    .editSemantic({ property: "layer[bars].encoding.y.field", value: "year" })
    .editSemantic({ property: "layer[bars].encoding.y.fieldType", value: "ordinal" })
    .editSemantic({ property: "layer[bars].encoding.y.scale", value: "y" })
    .editSemantic({ property: "layer[bars].encoding.color.field", value: "sex" })
    .editSemantic({ property: "layer[bars].encoding.color.fieldType", value: "nominal" })
    .editSemantic({ property: "layer[bars].encoding.color.scale", value: "color" })
    .editSemantic({ property: "layer[bars].encoding.color.layout", value: "stack" })
    .editSemantic({ property: "scale[x].type", value: "linear" })
    .editSemantic({ property: "scale[x].domain", value: "auto" })
    .editSemantic({ property: "scale[x].range", value: "auto" })
    .editSemantic({ property: "scale[x].nice", value: true })
    .editSemantic({ property: "scale[x].zero", value: true })
    ...
    .editSemantic({ property: "guide.axis.x.scale", value: "x" })
    .editSemantic({ property: "guide.axis.x.coordinate", value: "main" })
    .editSemantic({ property: "guide.axis.x.title", value: "mean(perc)" })
    .editSemantic({ property: "guide.axis.y.scale", value: "y" })
    .editSemantic({ property: "guide.axis.y.coordinate", value: "main" })
    ...
    .editGraphics({ target: "bars", property: "stroke", value: "white" })
    .editGraphics({ target: "bars", property: "strokeWidth", value: 0.5 })
    .createGraphics({ id: "verticalGridLines", parent: "plot-main", type: "line", length: grid.length, before: "bars" })
    .editGraphics({ target: "verticalGridLines", property: "x1", value: grid.map(line => line.x1) })
    .editGraphics({ target: "verticalGridLines", property: "y1", value: grid.map(line => line.y1) })
    .editGraphics({ target: "verticalGridLines", property: "x2", value: grid.map(line => line.x2) })
    .editGraphics({ target: "verticalGridLines", property: "y2", value: grid.map(line => line.y2) })
    ...
    .editGraphics({ target: "verticalGridLines", property: "strokeDash", value: grid.map(() => []) })
    .createGraphics({ id: "xAxisLine", parent: "plot-main", type: "line" })
    .editGraphics({ target: "xAxisLine", property: "x1", value: xAxis.line.x1 })
    .editGraphics({ target: "xAxisLine", property: "y1", value: xAxis.line.y1 })
    .editGraphics({ target: "xAxisLine", property: "x2", value: xAxis.line.x2 })
