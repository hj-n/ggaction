...
export function createTemporalXPrimitives(rows) {
  ...
  return chart()
    ...
    .createGraphics({ id: "horizontalGridLines", type: "line", length: grid.length, before: "bars" })
    ...
    .createGraphics({ id: "colorLegendSymbols", type: "rect", length: items.length })
    ...
    .createGraphics({ id: "colorLegendLabels", type: "text", length: items.length })
...
export function createHorizontalBarPrimitives(rows) {
  ...
  return chart()
    ...
    .editGraphics({ target: "bars", property: "stroke", value: "white" })
    .editGraphics({ target: "bars", property: "strokeWidth", value: 0.5 })
    .createGraphics({ id: "verticalGridLines", type: "line", length: grid.length, before: "bars" })
