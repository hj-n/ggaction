...
적용한다. Native Node coverage table은 source-relative path로 parse하며 parser와 failure
policy 자체도 unit test한다. Pure numeric grammar는 고정 fixture 외에도 monotonic mapping,
