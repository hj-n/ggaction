...
- [ ] `createTitle` option validation과 기본값
- [ ] Plot-aligned top layout 추론
- [ ] Semantic title과 subtitle 저장
- [ ] Wrapped title text create/edit actions
- [ ] Wrapped subtitle text create/edit actions
- [ ] `rematerializeTitle` 구현
- [ ] Canvas 변경 시 title layout 갱신
- [ ] 별도 actions program의 raw title block 제거
- [ ] Unit, acceptance, PNG regression
- [ ] 영어 Title/action/LLM 문서 갱신
