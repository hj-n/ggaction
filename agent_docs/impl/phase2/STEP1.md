...
- [x] 고해상도 PNG render test
- [x] 브라우저 결과 확인
- [x] 관련 영어 primitive/rendering 문서
...
- Unit/acceptance test 150개 통과
- PNG render test 4개 통과
- Primitive line chart: 406 source rows, 36 aggregate points, 3 series paths
- Browser Canvas: 720×460
- `pixelRatio: 2` PNG: 1440×920
- Combined legend에 solid/dashed/dotted line symbol 확인
- Browser warning/error 없음
