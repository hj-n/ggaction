...
> **문서 상태 — 현재 실행 계획.** Phase 8 facet columns, scale policy와 guide policy editing 구현과 검증을
> 완료했고 R41-P8-A는 `ready-for-review`다. 사용자 explicit approval 전까지 Phase 9는 차단한다.
...
| 8 | in-progress | Facet policy editing complete; R41-P8-A review 대기 |
