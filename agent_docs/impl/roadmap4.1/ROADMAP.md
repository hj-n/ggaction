...
> **문서 상태 — 현재 실행 계획.** Phase 4 Cartesian axis component lifecycle의 R41-P4-A가 승인되었고
> Phase 5 `editBin2DData` partial revision facade를 진행한다.
...
| 5 | in-progress | `editBin2DData` partial revision facade |
