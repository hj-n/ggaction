...
> **문서 상태 — 현재 실행 계획.** Phase 3 legend lifecycle의 R41-P3-A가 승인되었고 Phase 4 Cartesian axis
> component lifecycle을 진행한다.
...
| 4 | in-progress | Cartesian complete-axis component removal |
