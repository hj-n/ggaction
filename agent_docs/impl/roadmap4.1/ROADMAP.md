...
> **문서 상태 — 현재 실행 계획.** R41-P6-A가 승인되어 Phase 6를 완료했고 Phase 7 box/gradient data and
> positional-role revisions를 진행한다.
...
| 7 | in-progress | Box/gradient data와 positional-role revisions |
