...
> **문서 상태 — 현재 실행 계획.** Phase 0 contract Gate가 진행 중이다. 현재 observable behavior는
...
| Phase | 상태 | 범위 |
| ---: | --- | --- |
| 0 | in-progress | 선택 범위 재감사, exact public contract proposal과 R41-P0-A 승인 |
| 1 | planned | Encoding/radius teardown과 point/arc outline removal |
| 2 | planned | Selection/highlight edit/remove lifecycle |
| 3 | planned | Stroke-width legend edit와 selective legend block removal |
| 4 | planned | Cartesian complete-axis component removal |
| 5 | planned | `editBin2DData` partial revision facade |
| 6 | planned | Error bar/band, density, regression statistical revisions와 boundary disable |
| 7 | planned | Box/gradient data와 positional-role revisions |
| 8 | planned | Facet columns, scale policy와 guide policy editing |
| 9 | planned | Cross-capability regression, docs/package closeout |
