...
| Phase | 상태 | 범위 |
| ---: | --- | --- |
| 0 | in-progress | Exact public API, compatibility와 evidence contract; R42-P0-A |
| 1 | planned | Shared traversal/drawing target boundary와 Canvas/PNG regression; R42-P1-A |
| 2 | planned | Browser-safe SVG renderer, deterministic output와 visual review; R42-P2-A |
