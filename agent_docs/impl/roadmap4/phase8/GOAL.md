...
- [x] independent categorical-density oracle와 full/split primitive
- [x] P8-A 사용자 승인
...
| P8-Exit | approved | Current inventory, architecture, docs/types/package와 cumulative verification | Phase 9 |
