...
| --- | --- | --- | --- |
| P5-A | preparing | API/edge 규칙, independent oracle, Cars primitive PNG | production action 구현 |
| P5-B | blocked | Window public chain, state/trace, revision과 package parity | 2D bin production 구현 |
